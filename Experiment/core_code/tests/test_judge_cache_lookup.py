...
def test_judge_label_codex():
    spec = {"backend": "codex", "model": "gpt-5-codex-mini"}
...
def test_find_cached_judge_label_collision_raises(tmp_path):
    ...
    judges_dir = tmp_path / "judges"
    stored_spec = {"backend": "vllm", "model": "qwen36-35b-a3b-fp8",
                   "vllm_sampling": {"temperature": 0.6}}
    requested_spec = {"backend": "vllm", "model": "qwen36-35b-a3b-fp8",
