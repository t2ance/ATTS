...
|---|----------|-------------|---------------|--------|--------|
| D1 | Table 1a, HLE Pass@1 cost | $0.28 | $0.50 | delegated.log: $50.34/100 = $0.5034 | TODO |
| D2 | Table 1a, HLE Skywork cost | $2.22 | $4.41 | N=8 explore cost $440.73/100. Paper used best-of-4 cost by mistake | TODO |
| D3 | Table 1a, HLE LLM Selection acc | 58.00% | TBD (补跑中) | 99/100 done, 57 correct. Waiting for Q100 | TODO |
| D4 | Table 1c, GPQA Majority Voting acc | 74.24% | 73.74% (146/198) | Pass@1 value was copy-pasted into MV row | TODO |
| D5 | Table 1d, BV Majority Voting overall | 22.42% | 23.20% (90/388) | Per-subset numbers sum to 90/388=23.20%, not 87/388=22.42% | TODO |
| D6 | Table 3, BV +Integrator cost | $0.34 | $0.38 | delegated.log avg $0.3775/q | TODO |
| D7 | Sec 5 + Sec 6, "88% use 2 explores" | 88% | 82% (163/198) | 88% is from with-integrator run, default ATTS is 82% | TODO |

## Minor Rounding (fix for consistency)

| # | Location | Paper Value | Correct Value | Status |
|---|----------|-------------|---------------|--------|
| R1 | Table 1c, GPQA ATTS cost | $0.35 | $0.36 ($70.60/198) | TODO |
| R2 | Table 3, GPQA Default cost | $0.35 | $0.36 (same as R1) | TODO |
| R3 | Table 5, GPQA Sonnet orch cost | $0.35 | $0.36 (same as R1) | TODO |

## Questionable (need investigation)

| # | Location | Paper Value | Issue | Status |
|---|----------|-------------|-------|--------|
| Q1 | Table 1c, GPQA Pass@1 acc | 74.24% | no_integrate delegated.log says 74.75% (148/198), but results.jsonl first_candidate_correct=147/198=74.24%. 1-question grading inconsistency | TODO |
| Q2 | Table 6, AIME 2026 Pass@1 | 93.33% | no_integrate delegated.log says 96.67% (29/30), with-integrator says 93.33% (28/30). 1-question grading inconsistency between runs | TODO |

## Figure-Table Inconsistency

| # | Location | Table Value | Figure Value | Status |
|---|----------|-------------|-------------|--------|
| F1 | GPQA effort High | Table 4: 82.32%, $0.40 (v1 run) | Plot script uses v2 run: 81.82%, $0.66 | TODO |
...
| E3 | L262 BV paragraph | "ATTS leads on BabyVision" | If BV MV=23.20%, then MV also ties. Fix wording | TODO |
| E4 | L262 BV paragraph | "ahead of Majority Voting (22.42%)" | Update to 23.20% | TODO |
